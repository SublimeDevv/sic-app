    ...
    <div class="bg-white md:flex md:justify-center justify-center  md:w-4/12 p-6 rounded-lg shadow-xl ml-[480px]">
        <form action="{{ route('students.store') }}" class="w-full max-w-lg mx-auto" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="lastname_student" id="lastname_student" placeholder="Apellidos"
                    value="{{ old('lastname_student') }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="id_student" id="id_student" placeholder="Matrícula"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="email_student" id="email_student" placeholder="Correo Electrónico"
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password_student" id="password_student" placeholder="Contraseña"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
